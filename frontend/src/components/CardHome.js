...
// Components
import { timeAgo, constructDivResourceURL } from "./componentUtils";
    ...
    return (
        <a
            ...
            <div className="h-36 w-36 shrink-0 bg-cover bg-center rounded"
                style={{ backgroundImage: postContent.image ? constructDivResourceURL(postContent.image) : `url(${getDefaultImage()})` }}></div>
